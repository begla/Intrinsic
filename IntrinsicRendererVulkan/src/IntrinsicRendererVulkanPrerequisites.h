...
#define _INTR_VK_PER_INSTANCE_UNIFORM_MEMORY_IN_BYTES                          \
  (_INTR_VK_PER_INSTANCE_DATA_BUFFER_COUNT *                                   \
       _INTR_VK_PER_INSTANCE_PAGE_SMALL_SIZE_IN_BYTES *                        \
       _INTR_VK_PER_INSTANCE_PAGE_SMALL_COUNT +                                \
   _INTR_VK_PER_INSTANCE_DATA_BUFFER_COUNT *                                   \
       _INTR_VK_PER_INSTANCE_PAGE_LARGE_SIZE_IN_BYTES *                        \
       _INTR_VK_PER_INSTANCE_PAGE_LARGE_COUNT)
#define _INTR_VK_PER_MATERIAL_UNIFORM_MEMORY_IN_BYTES                          \
  (_INTR_VK_PER_MATERIAL_PAGE_SIZE_IN_BYTES * _INTR_VK_PER_MATERIAL_PAGE_COUNT)
