...
layout (location = 1) out vec2 outPixelPos;
layout (location = 2) out vec4 outOffsets[3];
...
void main()
{
  ...
  SMAABlendingWeightCalculationVS(position, gl_Position, outUV0, outPixelPos, outOffsets);
}
