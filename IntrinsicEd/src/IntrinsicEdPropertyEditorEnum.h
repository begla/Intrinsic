...
class IntrinsicEdPropertyEditorEnum : public IntrinsicEdPropertyEditorBase
{
  Q_OBJECT

public:
  IntrinsicEdPropertyEditorEnum(rapidjson::Document* p_Document,
                                rapidjson::Value* p_CurrentProperties,
                                rapidjson::Value* p_CurrentProperty,
                                const char* p_PropertyName,
                                QWidget* parent = nullptr);
  ~IntrinsicEdPropertyEditorEnum();
